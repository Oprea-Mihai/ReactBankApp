...
const Footer = () => (
  <section className={`${styles.flexCenter}${styles.paddingY} flex-col`}>
    <div
      className={`${styles.flexCenter} md:flex-row flex-col
       mb-8 w-full`}
    >
      <div className="flex-1 flex flex-col justify-start mr-10">
        ...
        />
        <p className={`${styles.padding} mt-4 max-w-[310px]`}>
      ...
      <div
       ...
       justify-normal flex-wrap md:mt-0 mt-10"
      >
      ...
      <div className="flex flex-row md:mt-0 mt-6">
        {socialMedia.map((social, index) => (
          <img
            ...
            src={social.icon}
            alt={social.id}
            className={`w-[21px] h-[21px] object-contain cursor-poiner
